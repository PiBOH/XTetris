questo file contiene una lista delle cosa fatte e da fare
- [x] Aggiunto [script](https://github.com/PiBOH/XTetris/blob/main/MENU-XTETRIS-WINDOWS.bat) per l'installazione automatica delle dipendenze e l'esecuzione di XTetris con le relative [guide](https://github.com/PiBOH/XTetris/tree/main/guide) (windows).
- [x] Aggiornato file [README](https://github.com/PiBOH/XTetris/blob/main/README.md)
