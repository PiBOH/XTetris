...
call :check_critical_file "%ROOT%\piboh-portable\Notepad++Portable\plugins\NppMarkdownPanel\style.css"
call :check_optional_file "%ROOT%\piboh-portable\Notepad++Portable\plugins\NppMarkdownPanel\NppMarkdownPanel.dll"
