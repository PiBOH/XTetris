...
set "LOG_FILE=%LOG_DIR%\install-launcher.log"
>> "%LOG_FILE%" echo [%date% %time%] Avvio piboh-script/installa-compila-windows.bat

echo XTetris Windows Launcher %SCRIPT_VERSION%
